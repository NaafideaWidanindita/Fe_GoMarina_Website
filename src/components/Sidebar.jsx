    ...
    return (
        ...
        <aside className="sidebar">
            <div className="sidebars">
                ...
                >
                    <Link to="/">
                        <img src="src/assets/material-symbols_home.png" alt="" style={{ marginBottom: '-0.8rem' }} />
                ...
                >
                    <Link to="/produk">
                        <img src="/src/assets/material-symbols_orders-rounded.png" alt="" style={{ marginBottom: '-1.4rem' }} />
                ...
                <div className={`sidebar-item ${activeItem === "pesanan" ? "active" : ""}`} 
                        ...
                        >
                    <Link to="/pesanan">
                        <img src="/src/assets/material-symbols_receipt-rounded.png" alt="" style={{ marginBottom: '-1.2rem'}} />
                ...
                >
                    <Link to="/kelolakonten">
                        <img src="/src/assets/material-symbols_post-add.png" alt="" style={{ marginBottom: '-0.2rem'}} />
                ...
                >
                    <Link to="/kelolapembayaran">
                        <img src="/src/assets/material-symbols_payments-outline-rounded.png" alt="" style={{ marginBottom: '-0.2rem'}} />
                        <div className="text" style={{ paddingBottom: '0.6rem'}}>
                        <div>Kelola</div> 
                        <div>Pembayaran</div>
                        </div>
                ...
                >
                    <Link to="/laporanpenjualan">
                        <img src="/src/assets/material-symbols_ssid-chart.png" alt="" style={{ marginBottom: '-0.2rem'}} />
                        <div className="text" style={{ paddingBottom: '0.6rem'}}>
                        <div>Laporan</div> 
                        <div>Penjualan</div>
                        </div>
